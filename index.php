...
<style amp-custom>
	...
	#section-goals {
		background: linear-gradient(45deg, rgba(50,190,210,.8), rgba(90,90,90,.5) 70%), linear-gradient(135deg, rgba(0,40,250,1), rgba(70,180,220,.7) 70%), linear-gradient(225deg, rgba(20,20,20,1), rgba(80,80,80,1) 70%);
